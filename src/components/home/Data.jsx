...
const Data = () => {
    ...
    return (
        <div className="home__data">
            <h1 className="home__title">José M. Polo
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">
                "¡Hola! Soy <strong>José Manuel Polo, Técnico Superior en Desarrollo de Aplicaciones Web</strong> tras finalizar un Grado Superior.
                 Durante los últimos 10 años, he trabajado en el sector logístico, donde desarrollé habilidades sólidas en organización, adaptabilidad y trabajo en equipo.
                <br />Decidí cambiar de rumbo profesional y, tras dos años de estudios intensivos, trabajo y familia, logré mi sueño de convertirme en Desarrollador Web. Aunque fue un reto pasar de ser un profesional senior en logística a un junior en desarrollo web, estoy entusiasmado por esta nueva etapa.
                <br />Mi objetivo es aplicar todo lo aprendido hasta ahora y seguir creciendo en este campo. Estoy emocionado por la posibilidad de unirme a un equipo donde pueda contribuir con mis conocimientos y continuar desarrollándome profesionalmente en el desarrollo web.
            </p>
